...
<div class="container pt-3 my-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-chevron p-3 bg-body-tertiary rounded-3">
            ...
            <li class="breadcrumb-item">
                <a class="link-body-emphasis fw-semibold text-decoration-none" href="/{{ $selected_source }}">
                ...
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                            <a href="/{{ $selected_source }}/{{ $selected_category }}/{{ $head_value['id'] }}" type="button" class="btn btn-primary btn-lg px-4 me-md-2">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body py-0">
                        <a href="/{{ $selected_source }}/{{ $selected_category }}/{{ $pop_value['id'] }}" class="stretched-link text-body-emphasis" style="text-decoration: none;">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 pt-3">
        ...
        <div class="col">
            <div class="card h-100 border-0">
                ...
                <div class="card-body">
                    <a href="/{{ $selected_source }}/{{ $selected_category }}/{{ $json_value['id'] }}" class="stretched-link text-body-emphasis" style="text-decoration: none;">
